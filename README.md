...
PICtendo combines both <a href="https://github.com/stevenchadburrow/PICnes">PICnes</a> and <a href="https://github.com/stevenchadburrow/PICboy">PICboy</a> into a single emulator with common functionality and memory spaces.  All of the advanced features from both emulators are still here, including RAM saves, turbo, fast-forward, freeze, and (NES) save states.
